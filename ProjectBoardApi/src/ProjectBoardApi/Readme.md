...
WORKDIR /src
COPY ["ProjectBoardApi.csproj", "ProjectBoardApi/"]
RUN dotnet restore "ProjectBoardApi/ProjectBoardApi.csproj"

WORKDIR "/src/ProjectBoardApi"
COPY . .
RUN dotnet build "ProjectBoardApi.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "ProjectBoardApi.csproj" \
...
Execute unit tests
```
cd "ProjectBoardApi/test/ProjectBoardApi.Tests"
dotnet test
```

Deploy function to AWS Lambda
```
cd "ProjectBoardApi/src/ProjectBoardApi"
